...
from custom_components.solis_modbus.const import PROTO_BOTH_MANUAL
from custom_components.solis_modbus.helpers import get_controller_from_entry, redact_config
...
async def async_setup_entry(
    ...
    if getattr(controller, "mode", None) == PROTO_BOTH_MANUAL:
        from custom_components.solis_modbus.sensors.solis_protocol_select import SolisProtocolSelect
