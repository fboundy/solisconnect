...
from custom_components.solis_modbus.helpers import notify_register_update
...
class SolisInverterHub(SolisControllerBase):
    ...
    def _start_retrieval(self, protocol: str):
        ...
        if protocol == PROTOCOL_MODBUS:
            ...
            from custom_components.solis_modbus.cloud.cloud_retrieval import CloudDataRetrieval
