...
from custom_components.solisconnect.helpers import clock_drift_test, decode_inverter_model, is_correct_controller, register_update_signal
...
class SolisDerivedSensor(RestoreSensor, SensorEntity):
    ...
    def handle_modbus_update(self, data):
        ...
        if not is_correct_controller(self.base_sensor.controller, data):
